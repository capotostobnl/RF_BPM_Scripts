...
c.drawImage('Images/SR:C09-BI{BPM:7}.png', 25.5*cm, 11.5*cm, 9*cm, 12*cm)
...
c.drawImage('Images/SR:C09-BI{BPM:8}.png', 25.5*cm, 0*cm, 9*cm, 12*cm)
...
c.drawImage('Images/SR:C29-BI{BPM:7}.png', 25.5*cm, 11.5*cm, 9*cm, 12*cm)
c.drawImage('Images/SR:C29-BI{BPM:8}.png', 34*cm, 11.5*cm, 9*cm, 12*cm)
...
c.drawImage('Images/SR:C29-BI{BPM:9}.png', 25.5*cm, 0*cm, 9*cm, 12*cm)
c.drawImage('Images/SR:C29-BI{BPM:10}.png', 34*cm, 0*cm, 9*cm, 12*cm)
